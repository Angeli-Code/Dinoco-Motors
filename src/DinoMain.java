...
/**
 * Application that allows you to view the contents of the Dinoco
 * Car Inventory
 *
...
public class DinoMain
{
	public static void main(String[] args)
	{
		...
		MenuFrame menuFrame = new MenuFrame(guiMan,null,null,db,
						    debugMode);
		SearchFrame searchFrame = new SearchFrame(guiMan,menuFrame,
							  debugMode);
		SliderFrame sliderFrame = new SliderFrame(guiMan,menuFrame,
							  debugMode);
